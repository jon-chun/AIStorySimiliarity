...
# full_prompt = f"CHARACTER_REFERENCE:\n\n{reference_character} " +
#               f"CHARACTER_TEST:\n\n{character_test} " +
#               prompt_compare_characters

prompt_compare_characters = f"""
...
COMPARE the similarities between the above ###CHARACTER_TEST
and the baseline ###CHARACTER_REFERENCE 
using the above ###CHARACTER_FEATURES then
...
Return your response in JSON form following this ###TEMPLATE
