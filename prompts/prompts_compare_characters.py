...
prompt_similarity_characters_testfilm = f"""
###TEST_FILM:
""";
...
##### <RESPONSE> #####
{
    "reference_film": {
        ...
        "features": {
            ...
            "social_dynamics": "Indiana Jones often works alone but can rally others to his cause, with relationships complicated by his singular focus.",
    ...
    "test_film": {
        ...
        "features": {
            ...
            "social_dynamics": "Benjamin Franklin Gates is the leader of the group, often in conflict with others over the risks of their quest but ultimately inspiring loyalty.",
    ...
    "similarity_by_features": {
        ...
        "social_dynamics": "Both characters have complex social interactions, often leading and inspiring others while facing conflicts. (Similarity Score: 80)",
