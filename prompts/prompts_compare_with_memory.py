...
prompt_similarity_to_memory_start = f"""
###SETUP:
...
prompt_similarity_to_memory_middle = f"""

###REFERENCE:
""";


prompt_similarity_to_memory_end = f"""

###INSTRUCTIONS:
You are a world-famous narratologist and film scholar.
