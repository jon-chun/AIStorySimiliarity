# ./similarity_customizations/SIMILARITY_WEIGHTS.PY

# Weights for each narrative element contributing to 'overall' similarity metric

element_weights_dict = {"characters": 25, "plot": 25, "setting": 25, "themes": 25}



# Weights for each features under all 4 narrative elements
