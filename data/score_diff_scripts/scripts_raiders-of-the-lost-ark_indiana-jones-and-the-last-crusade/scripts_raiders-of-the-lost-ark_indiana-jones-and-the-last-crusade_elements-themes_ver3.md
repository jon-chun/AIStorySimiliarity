Based on the information provided in the scripts for "Raiders of the Lost Ark" and "Indiana Jones and the Last Crusade," I will compare the thematic elements using the specified features. 
