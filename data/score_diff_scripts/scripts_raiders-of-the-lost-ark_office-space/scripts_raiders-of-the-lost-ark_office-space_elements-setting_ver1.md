Here is a comparison between the scripts of "Office Space" (1999) and "Raiders of the Lost Ark" (1981) using the specified elements:
...
```json
{
    ...
    "cultural_context": {
        "similarity": 30,
        "reasoning": "Both stories are influenced by their cultural contexts—archaeology and the Nazi threat in the 'Reference Element' versus the corporate culture and dissatisfaction in the 'Test Element.' While the cultural settings differ, they both deeply impact the characters' lives and pursuits."
    },
    "social_class": {
        "similarity": 40,
...
This comparison highlights the differences and some commonalities between the two scripts based on the specified elements.