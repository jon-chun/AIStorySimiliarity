...
# Calculate stats
claude_stats = claude_df.groupby('name')['similarity'].agg(['mean', 'std'])
gpt4o_stats = gpt4o_df.groupby('name')['similarity'].agg(['mean', 'std'])
genai_stats = genai_df.groupby('test_film')['overall'].agg(['mean', 'std'])
...
all_stats.index = all_stats.index.map(normalize_film_name)
